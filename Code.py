"""
Made for 12th Practical Project by Pushan Banerjee, XII - C
...
def ask_query():                                              # User's Query Solving Function
    ...
    if ques.casefold() != 'q':
        ...
        if ('time' in ques.casefold()) or ('timing' in ques.casefold()) or ('timings' in ques.casefold()):
            ...
            print("You can reach us on 9876543210, or just mail us at podhaba@gmail.com.")
            space()
            ask_query()
            ...
            print("Safety of our customers is our No. 1 priority. At PO’s, we take food safety"
            ...
            print("Sorry, please contact us on 9876543210 or podhaba@gmail.com,"
...
def finalmessage():                                       # Function to print the final goodbye message.
    print('*' * 75)
    print("\t\tThank You for choosing 'PO Dhaba'")
